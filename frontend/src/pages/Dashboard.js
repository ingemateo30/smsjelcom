      ...
      >
        ...
        <nav className="p-4 space-y-2">
          ...
          <div className="relative group">
            ...
            {/* Submenú: Normal cuando está expandido, Tooltip cuando está colapsado */}
            {!isCollapsed ? (
              <div className={`pl-6 space-y-1 transition-all duration-300 ${openSections.correos ? "block" : "hidden"}`}>
                <SidebarButton icon={<FaPaperPlane />} text="Correos automáticos" collapsed={isCollapsed} onClick={() => navigate("/dashboard/enviar-correos")} />
              ...
              <div className="absolute left-full top-0 bg-gray-800 text-white p-2 rounded-lg shadow-lg w-48 hidden group-hover:block">
                <SidebarButton icon={<FaPaperPlane />} text="Correo automático" collapsed={false} onClick={() => navigate("/dashboard/enviar-correos")} />
                <SidebarButton icon={<FaEnvelope />} text="Correo manual" collapsed={false} onClick={() => navigate("/dashboard/enviar-correo")} />
              </div>
            )}
          </div>
          ...
          <div className="relative group">
            ...
            {!isCollapsed ? (
              <div className={`pl-6 space-y-1 transition-all duration-300 ${openSections.sms ? "block" : "hidden"}`}>
                <SidebarButton icon={<FaSms />} text="SMS automáticos" collapsed={isCollapsed} onClick={() => navigate("/dashboard/enviar-sms")} />
                <SidebarButton icon={<FaMobileAlt />} text="SMS manual" collapsed={isCollapsed} onClick={() => navigate("/dashboard/enviar-sms-manual")} />
              </div>
            ) : (
              <div className="absolute left-full top-0 bg-gray-800 text-white p-2 rounded-lg shadow-lg w-48 hidden group-hover:block">
                <SidebarButton icon={<FaSms />} text="SMS automáticos" collapsed={false} onClick={() => navigate("/dashboard/enviar-sms")} />
                <SidebarButton icon={<FaMobileAlt />} text="SMS manual" collapsed={false} onClick={() => navigate("/dashboard/enviar-sms-manual")} />
              </div>
            )}
          </div>
